import regex
from undertheseaLocal.underthesea import word_tokenize, pos_tag, sent_tokenize
...
#################
#LOAD TEENCODE
file = open('utils/teencode.txt', 'r', encoding="utf8")
...
file = open('utils/english-vnmese.txt', 'r', encoding="utf8")
...
################
#LOAD wrong words
file = open('utils/wrong-word.txt', 'r', encoding="utf8")
wrong_lst = file.read().split('\n')
file.close()
#################
#LOAD STOPWORDS
file = open('utils/vietnamese-stopwords.txt', 'r', encoding="utf8")
...
def handle_preprocess_single_text(text):
    new_text = remove_stopword(process_special_word(process_postag_thesea(covert_unicode(process_text(text)))))
    return new_text

def handle_preprocess_dataframe(df):
